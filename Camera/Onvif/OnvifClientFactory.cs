...
{
    internal sealed class OnvifClientFactory
    {
        ...
        public TService CreateClient<TService>(Uri uri, ConnectionParameters connectionParameters, MessageVersion messageEncodingVersion)
        {
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        private static IEnumerable<BindingElement> CreateBindingElements(MessageVersion messageVersion, bool useTls, NetworkCredential credentials)
        {
            ...
            transport.AuthenticationScheme =
                string.IsNullOrEmpty(credentials.UserName) ? AuthenticationSchemes.Anonymous : AuthenticationSchemes.Basic;
